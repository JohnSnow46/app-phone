...
| [EveryInc/compound-engineering-plugin](https://github.com/EveryInc/compound-engineering-plugin) | MIT | Used to cross-check agent/skill frontmatter conventions against its `tests/fixtures/sample-plugin`; its per-skill human-doc-mirror convention noted above as optional, not built |
| [zhaoxuya520/reverse-skill](https://github.com/zhaoxuya520/reverse-skill) | MIT | Reviewed for structural ideas. Its per-skill Codex sidecar is the same convention already seen in mattpocock (out of scope — this template targets Claude Code only); its routing-coherence-check script was judged too heavy/domain-specific for a starter. Nothing adopted directly. |
